    ...
    <>
      ...
      <section className="border-b border-border">
        <div className="container-site py-20 lg:py-28">
          ...
          <h1 className="animate-rise delay-120 mt-6 max-w-3xl text-4xl leading-[1.08] text-foreground sm:text-5xl lg:text-6xl">
            Discover property. Find your place. Connect with Madulo Properties.
          </h1>
          <p className="animate-rise delay-240 mt-6 max-w-xl text-base leading-relaxed text-muted-foreground">
